...
export default {
	...
	methods: {
		...
		async go() {
			...
			let dohvat1 = await fetch("http://localhost:3000/posts");
			console.timeEnd("dohvat 1");
			console.time("dohvat 2");
			let dohvat2 = await fetch("http://localhost:3000/posts?test");
			console.timeEnd("dohvat 2");
			console.time("dohvat 3");
			let dohvat3 = await fetch("http://localhost:3000/posts");
